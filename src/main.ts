...
miniPlayer.innerHTML = `
  <div class="mini-player-main">
    <div class="mini-player-controls">
      <button class="mini-player-btn" type="button" data-mini-prev aria-label="Previous track">⏮</button>
      <button class="mini-player-btn" type="button" data-mini-toggle aria-label="Play or pause">
        <span>⏸</span>
      </button>
      <button class="mini-player-btn" type="button" data-mini-next aria-label="Next track">⏭</button>
    </div>
    <div class="mini-player-info">
      <div class="mini-player-track" id="miniTrackName">Apollo Act I</div>
      <div class="mini-player-time" id="miniTime">0:00 / 0:00</div>
    </div>
    <button class="mini-player-btn mini-player-btn--ghost" type="button" data-mini-playlist-toggle aria-label="Toggle playlist">☰</button>
  </div>
